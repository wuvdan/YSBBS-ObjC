...
@interface OtherMorePostViewController ()<DZNEmptyDataSetSource, DZNEmptyDataSetDelegate>
...
@implementation OtherMorePostViewController
...
- (void)setupSubviews{
    ...
    [self.wdNavigationBar.centerButton setTitle:@"所有帖子" forState:UIControlStateNormal];
}
...
- (void)getListOfUserPostWithPageNo:(NSInteger)pageNo {
    ...
    [[BBSNetworkTool shareInstance] getPostListUserId:self.userId pageSize:@"10" pageNo:pageNo successBlock:^(id  _Nonnull obj) {
        if (pageNo == 1) {
